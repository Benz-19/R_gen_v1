...
<head>
    ...
    <title>Individual Dashboard - ReconAgent</title>
    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-black/80 border-r border-neutral-800 flex flex-col justify-between shrink-0 backdrop-blur-md">
            ...
            <div class="p-4 border-t border-neutral-800 flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold text-white">Personal Account</p>
                    <p class="text-[10px] text-neutral-500">Individual Tier</p>
                </div>
        ...
        <main class="flex-1 overflow-y-auto p-8">
            <header class="flex justify-between items-center mb-8 pb-4 border-b border-neutral-800">
                <div>
                    <h1 class="text-2xl font-bold text-white tracking-tight">Personal Workspace</h1>
                    <p class="text-xs text-neutral-400 mt-1">Standalone financial data reconciliation platform</p>
                </div>
            ...
            <section class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="bg-black/40 border border-neutral-800 p-5 rounded-xl backdrop-blur-sm">
                    <p class="text-xs text-neutral-400 font-medium uppercase tracking-wider">Pending Exceptions</p>
                    <p class="text-2xl font-bold mt-2 text-emerald-400 font-mono">0</p>
                </div>
                <div class="bg-black/40 border border-neutral-800 p-5 rounded-xl backdrop-blur-sm">
                    <p class="text-xs text-neutral-400 font-medium uppercase tracking-wider">Unmatched Items</p>
